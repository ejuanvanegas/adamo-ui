...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        "adm:peer adm:data-[state=checked]:bg-primary adm:data-[state=unchecked]:bg-input adm:focus-visible:border-ring adm:focus-visible:ring-ring/50 adm:dark:data-[state=unchecked]:bg-input/80 adm:inline-flex adm:h-[1.15rem] adm:w-8 adm:shrink-0 adm:items-center adm:rounded-full adm:border adm:border-transparent adm:shadow-xs adm:transition-all adm:outline-none adm:focus-visible:ring-[3px] adm:disabled:cursor-not-allowed adm:disabled:opacity-50",
        className,
      )}
      {...props}
    >
