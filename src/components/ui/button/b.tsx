...
//     variants: {
//       variant: {
//         primary: "adm:bg-primary adm:text-primary-foreground adm:hover:bg-primary-700",
//         success:
...
//       },
//       size: {
//         sm: "adm:h-8 adm:gap-1.5 adm:px-3 adm:has-[>svg]:px-2.5",
//         md: "adm:h-9 adm:px-3 adm:py-2 adm:has-[>svg]:px-3",
//         lg: "adm:h-10 adm:px-4 adm:has-[>svg]:px-4",
//         "icon-sm": "adm:size-8",
//         icon: "adm:size-10",
//         "icon-md": "adm:size-9",
//         "icon-lg": "adm:size-10",
